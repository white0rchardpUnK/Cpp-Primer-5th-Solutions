...
#include <exception>
using std::bad_alloc; using std::out_of_range; using std::runtime_error;
...
private:
    ...
    void handle_out_of_memory(const bad_alloc &alloc);
};
...
template<typename T>
void Blob<T>::handle_out_of_memory(const bad_alloc &alloc) {
    return;
}
