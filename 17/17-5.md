...
using pair_iterator = pair<vector<Sales_data>::const_iterator, vector<Sales_data>::const_iterator>;
using matches = pair<vector<Sales_data>::size_type, pair_iterator>;
