...
int main(){
    ...
    vspQ.push_back(make_shared<Bulk_quote>("978-7-121-15535-2", 256.00, 128, 0.4));
    vspQ.push_back(make_shared<Bulk_quote>("978-7-121-15535-2", 128.00, 64, 0.3));
    vspQ.push_back(make_shared<Bulk_quote>("978-7-121-15535-2", 64.00, 32, 0.2));
    vspQ.push_back(make_shared<Bulk_quote>("978-7-121-15535-2", 32.00, 16, 0.1));
